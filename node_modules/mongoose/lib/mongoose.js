 ...
 * #### Example:
 *
 *     // with <redacted>@127.0.0.1:port/database');
 *
 *     // and options
 *     const opts = { db: { native_parser: true }}
 *     db = mongoose.createConnection('<redacted>@127.0.0.1:port/database', opts);
 *
 *     // replica sets
 *     db = mongoose.createConnection('<redacted>@127.0.0.1:port,anotherhost:port,yetanother:port/database');
 *
 *     // and options
 *     const opts = { replset: { strategy: 'ping', rs_name: 'testSet' }}
 *     db = mongoose.createConnection('<redacted>@127.0.0.1:port,anotherhost:port,yetanother:port/database', opts);
 *
 *     // initialize now, connect later
 *     db = mongoose.createConnection();
 *     await db.openUri('<redacted>@param {String} uri mongodb URI to connect to
 ...
 * #### Example:
 *
 *     mongoose.connect('<redacted>@127.0.0.1:port/database');
 *
 *     // replica sets
 *     const uri = '<redacted>@127.0.0.1:port,anotherhost:port,yetanother:port/mydatabase';
 ...
 *     const uri = '<redacted>@param {String} uri mongodb URI to connect to
 * @param {Object} [options] passed down to the [MongoDB driver's `connect()` function](https://mongodb.github.io/node-mongodb-native/4.9/interfaces/MongoClientOptions.html), except for 4 mongoose-specific options explained below.
 * @param {Boolean} [options.bufferCommands=true] Mongoose specific option. Set to false to [disable buffering](https://mongoosejs.com/docs/faq.html#callback_never_executes) on all models associated with this connection.
 ...
 *
 *     mongoose.createConnection('<redacted>@memberOf Mongoose
 * @instance
