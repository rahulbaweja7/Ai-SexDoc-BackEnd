 ...
 * #### Example:
 *
 *     mongoose.createConnection('<redacted>@property name
 * @memberOf Connection
 * @instance
 * @api public
 */
 ...
 * #### Example:
 *
 *     const db = mongoose.createConnection('<redacted>@property plugins
 * @memberOf Connection
 * @instance
 * @api public
 */
 ...
 * #### Example:
 *
 *     mongoose.createConnection('<redacted>@property host
 * @memberOf Connection
 * @instance
 * @api public
 */
 ...
 * #### Example:
 *
 *     mongoose.createConnection('<redacted>@property port
 * @memberOf Connection
 * @instance
 * @api public
 */
 ...
 * #### Example:
 *
 *     mongoose.createConnection('<redacted>@127.0.0.1:27017/mydb').user; // "val"
 *
 * @property user
 * @memberOf Connection
 * @instance
 ...
 * #### Example:
 *
 *     mongoose.createConnection('<redacted>@127.0.0.1:27017/mydb').pass; // "psw"
 *
 * @property pass
 * @memberOf Connection
 * @instance
 ...
 * #### Example:
 *
 *     const conn = mongoose.createConnection('<redacted>@method dropDatabase
 * @return {Promise}
 * @api public
 */
 ...
 * #### Example:
 *
 *     const db = mongoose.createConnection('<redacted>@param {Function} fn plugin callback
 ...
 * #### Example:
 *
 *     const conn = await mongoose.createConnection('<redacted>@api public
 * @return {Promise}
 */
 ...
 * #### Example:
 *
 *     const client = await mongodb.MongoClient.connect('<redacted>@api public
 ...
 *     const conn = await mongoose.createConnection('<redacted>@method useDb
 * @memberOf Connection
 ...
 *
 *     // Connect to `initialdb` first
 *     const conn = await mongoose.createConnection('<redacted>@method removeDb
 * @memberOf Connection
 * @param {String} name The database name
 * @return {Connection} this
 * @api public
