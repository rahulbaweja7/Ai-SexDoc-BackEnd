 ...
 *
 * const client = new MongoClient('<redacted>@param command - The command to execute
 ...
 * }
 *
 * const client = new MongoClient('<redacted>@param doc - The document to insert
     * @param options - Optional settings for the command
     */
 ...
 * }
 *
 * const client = new MongoClient('<redacted>@param client - The MongoClient for the database.
 ...
 * const client = new MongoClient('<redacted>@param models - The client bulk write models.
     ...
     *
     * @remarks
     * The driver will look up corresponding SRV and TXT records if the connection string starts with `<redacted>@see docs.mongodb.org/manual/reference/connection-string/
     */
     ...
     *
     * @remarks
     * The driver will look up corresponding SRV and TXT records if the connection string starts with `<redacted>@see https://www.mongodb.com/docs/manual/reference/connection-string/
     */
